...
abstract class TestCase extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Asserts that an array contains an instance of a particular class
     * @param $class
     * @param array $array
     */
    public function assertContainsInstancesOf($class, array $array, $message = '')
    {
        if(!is_string($class)) {
            throw new \InvalidArgumentException('$class must be given as a string');
        }
        $message = $message ?: "Failed asserting that array contains instance of $class";
